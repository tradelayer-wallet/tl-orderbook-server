...
export const createContract = (contractId: number, contractName: string, collateral: number, disabled: boolean): IContract => {
    return { contractId, contractName, collateral, disabled };
};
